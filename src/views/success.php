...
<section id="payment-detail" class="p-4 mt-12 mx-auto sm:max-w-screen max-w-4xl border text-center">
  ...
  <a class="sm:p-4 p-2 border rounded bg-indigo-600 text-white sm:text-2xl sm:w-full hover:cursor-pointer hover:bg-indigo-800" 
  href="<?=$url?>"
    target="_blank">Descargar boleta</a>
